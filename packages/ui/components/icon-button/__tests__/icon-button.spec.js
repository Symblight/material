...
describe("md-icon-button", () => {
  describe("rendering", () => {
    it("renders the host element", async () => {
      const el = /** @type {IconButton} */ (
        await fixture(html`<md-icon-button></md-icon-button>`)
      );
      expect(el).to.exist;
    });
  ...
  describe("variant", () => {
    ...
    it('reflects variant="filled" to the host', async () => {
      const el = /** @type {IconButton} */ (
        await fixture(html`<md-icon-button variant="filled"></md-icon-button>`)
      );
    ...
    it('reflects variant="tonal" to the host', async () => {
      const el = /** @type {IconButton} */ (
        await fixture(html`<md-icon-button variant="tonal"></md-icon-button>`)
      );
    ...
    it("falls back to standard for an invalid variant", async () => {
      ...
      /** @type {any} */ (el).variant = "invalid-variant";
  ...
  describe("selected", () => {
    ...
    it("reflects selected attribute to the host", async () => {
      const el = /** @type {IconButton} */ (
        await fixture(html`<md-icon-button selected></md-icon-button>`)
      );
  ...
  describe("toggle", () => {
    ...
    it("reflects toggle attribute to the host", async () => {
      const el = /** @type {IconButton} */ (
        await fixture(html`<md-icon-button toggle></md-icon-button>`)
      );
    ...
    it("renders selected slot when toggle=true and selected=true", async () => {
      ...
      const selectedSlot = /** @type {HTMLSlotElement} */ (
        el.shadowRoot.querySelector('slot[name="selected"]')
      );
  ...
  describe("disabled", () => {
    ...
    it("disables the inner button when disabled is set", async () => {
      const el = /** @type {IconButton} */ (
        await fixture(html`<md-icon-button disabled></md-icon-button>`)
      );
      const button = /** @type {HTMLButtonElement} */ (
        el.shadowRoot.querySelector("button")
      );
  ...
  describe("href", () => {
    it("renders an <a> element when href is set", async () => {
      const el = /** @type {IconButton} */ (
        await fixture(html`<md-icon-button href="/home"></md-icon-button>`)
      );
  ...
  describe("type", () => {
    ...
    it("sets the button type when type attribute is set", async () => {
      const el = /** @type {IconButton} */ (
        await fixture(html`<md-icon-button type="submit"></md-icon-button>`)
      );
      const button = /** @type {HTMLButtonElement} */ (
        el.shadowRoot.querySelector("button")
      );
  ...
  describe("BaseButton lifecycle", () => {
    ...
    it("form submission via type=submit triggers form submit", async () => {
      ...
      const el = /** @type {IconButton} */ (
        form.querySelector("md-icon-button")
      );
      el.click();
      await el.updateComplete;
