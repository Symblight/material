...
| `--md-text-field-disabled-foreground-color` | *(system token)*                               | Text color when disabled               |
| `--md-text-field-disabled-background-color` | *(system token)*                               | Background color when disabled         |
...
| `--md-filled-text-field-background-indicator` | *(system token)*             | Bottom indicator color (filled) |
| `--md-outlined-text-field-shape`            | `0.25rem`                      | Corner radius (outlined variant)|
| `--md-outlined-text-field-border-color`     | *(system token)*               | Border color (outlined variant) |
