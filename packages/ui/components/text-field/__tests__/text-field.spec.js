...
describe("md-text-field", () => {
  ...
  describe("rendering", () => {
    it("renders an inner <input> by default", async () => {
      const el = /** @type {TextField} */ (
        await fixture(html`<md-text-field></md-text-field>`)
      );
    ...
    it("renders a <textarea> when multiline is set", async () => {
      const el = /** @type {TextField} */ (
        await fixture(html`<md-text-field multiline></md-text-field>`)
      );
  ...
  describe("variant", () => {
    ...
    it("adds text-field_variant_filled class for filled variant", async () => {
      const el = /** @type {TextField} */ (
        await fixture(html`<md-text-field variant="filled"></md-text-field>`)
      );
      expect(
        el.shadowRoot
    ...
    it("adds text-field_variant_outlined class for outlined variant", async () => {
      const el = /** @type {TextField} */ (
        await fixture(html`<md-text-field variant="outlined"></md-text-field>`)
      );
      expect(
        el.shadowRoot
          .querySelector(".text-field")
  ...
  describe("label", () => {
    it("renders a label element when label is set (filled)", async () => {
      const el = /** @type {TextField} */ (
        await fixture(html`<md-text-field label="Email"></md-text-field>`)
      );
  ...
  describe("value", () => {
    ...
    it("sets the inner input value", async () => {
      const el = /** @type {TextField} */ (
        await fixture(html`<md-text-field value="hello"></md-text-field>`)
      );
      expect(
  ...
  describe("type", () => {
    ...
    it("passes type to the inner input", async () => {
      const el = /** @type {TextField} */ (
        await fixture(html`<md-text-field type="email"></md-text-field>`)
      );
      expect(
        /** @type {HTMLInputElement} */ (el.shadowRoot.querySelector("input"))
          .type,
  ...
  describe("disabled", () => {
    ...
    it("disables the inner input", async () => {
      const el = /** @type {TextField} */ (
        await fixture(html`<md-text-field disabled></md-text-field>`)
      );
      expect(
        /** @type {HTMLInputElement} */ (el.shadowRoot.querySelector("input"))
          .disabled,
  ...
  describe("readOnly", () => {
    it("sets readonly on the inner input", async () => {
      const el = /** @type {TextField} */ (
        await fixture(html`<md-text-field readOnly></md-text-field>`)
      );
      expect(
        /** @type {HTMLInputElement} */ (el.shadowRoot.querySelector("input"))
          .readOnly,
  ...
  describe("required", () => {
    ...
    it("sets required on the inner input", async () => {
      const el = /** @type {TextField} */ (
        await fixture(html`<md-text-field required></md-text-field>`)
      );
      expect(
        /** @type {HTMLInputElement} */ (el.shadowRoot.querySelector("input"))
          .required,
  ...
  describe("error", () => {
    it("adds text-field_status_error class when error is set", async () => {
      const el = /** @type {TextField} */ (
        await fixture(html`<md-text-field error></md-text-field>`)
      );
      expect(
        el.shadowRoot
          .querySelector(".text-field")
  ...
  describe("handleFocus", () => {
    ...
    it("populated returns true when focused (no value)", async () => {
      ...
      expect(/** @type {any} */ (el).populated).to.be.true;
    });
  });
