...
describe("md-checkbox", () => {
  ...
  describe("rendering", () => {
    it("renders an inner input[type=checkbox]", async () => {
      const el = /** @type {Checkbox} */ (
        await fixture(html`<md-checkbox></md-checkbox>`)
      );
  ...
  describe("checked", () => {
    ...
    it("reflects checked attribute to the host", async () => {
      const el = /** @type {Checkbox} */ (
        await fixture(html`<md-checkbox checked></md-checkbox>`)
      );
  ...
  describe("indeterminate", () => {
    ...
    it("adds .checkbox__box_indeterminate class", async () => {
      const el = /** @type {Checkbox} */ (
        await fixture(html`<md-checkbox indeterminate></md-checkbox>`)
      );
      expect(
        el.shadowRoot
          .querySelector(".checkbox__box")
    ...
    it("does not show indeterminate icon when checked takes precedence", async () => {
      const el = /** @type {Checkbox} */ (
        await fixture(html`<md-checkbox checked indeterminate></md-checkbox>`)
      );
      const box = el.shadowRoot.querySelector(".checkbox__box");
  ...
  describe("disabled", () => {
    ...
    it("reflects disabled attribute to the host", async () => {
      const el = /** @type {Checkbox} */ (
        await fixture(html`<md-checkbox disabled></md-checkbox>`)
      );
  ...
  describe("error", () => {
    it("adds error classes to input and box when error is set", async () => {
      const el = /** @type {Checkbox} */ (
        await fixture(html`<md-checkbox error></md-checkbox>`)
      );
      expect(
        el.shadowRoot
  ...
  describe("name and value", () => {
    ...
    it("passes name to the inner input", async () => {
      const el = /** @type {Checkbox} */ (
        await fixture(html`<md-checkbox name="agree"></md-checkbox>`)
      );
      expect(
        /** @type {HTMLInputElement} */ (el.shadowRoot.querySelector("input"))
          .name,
    ...
    it("passes value to the inner input", async () => {
      const el = /** @type {Checkbox} */ (
        await fixture(html`<md-checkbox value="yes"></md-checkbox>`)
      );
      expect(
        /** @type {HTMLInputElement} */ (el.shadowRoot.querySelector("input"))
          .value,
  ...
  describe("required", () => {
    ...
    it("sets required on the inner input", async () => {
      const el = /** @type {Checkbox} */ (
        await fixture(html`<md-checkbox required></md-checkbox>`)
      );
      expect(
        /** @type {HTMLInputElement} */ (el.shadowRoot.querySelector("input"))
          .required,
  ...
  describe("form association", () => {
    ...
    it("form getter returns the associated form", async () => {
      ...
      const el = /** @type {Checkbox} */ (form.querySelector("md-checkbox"));
    ...
    it("labels getter returns associated labels", async () => {
      ...
      const el = /** @type {Checkbox} */ (
        container.querySelector("md-checkbox")
      );
