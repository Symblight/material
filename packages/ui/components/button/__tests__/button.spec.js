...
describe("md-button", () => {
  ...
  describe("rendering", () => {
    it("renders a <button> element by default", async () => {
      const el = /** @type {Button} */ (
        await fixture(html`<md-button>Label</md-button>`)
      );
    ...
    it("renders an <a> element when href is set", async () => {
      const el = /** @type {Button} */ (
        await fixture(html`<md-button href="/home">Link</md-button>`)
      );
    ...
    it("renders slot content as the label", async () => {
      const el = /** @type {Button} */ (
        await fixture(html`<md-button>Click me</md-button>`)
      );
  ...
  describe("variant", () => {
    ...
    for (const variant of ["filled", "outlined", "text", "elevated", "tonal"]) {
      it(`sets variant="${variant}" attribute`, async () => {
        const el = /** @type {Button} */ (
          await fixture(html`<md-button variant=${variant}>Label</md-button>`)
        );
  ...
  describe("disabled", () => {
    ...
    it("disables the inner button when disabled prop is set", async () => {
      const el = /** @type {Button} */ (
        await fixture(html`<md-button disabled>Label</md-button>`)
      );
      const inner = el.shadowRoot.querySelector("button");
  ...
  describe("loading", () => {
    it("shows md-progress-circular when loading", async () => {
      const el = /** @type {Button} */ (
        await fixture(html`<md-button loading>Label</md-button>`)
      );
  ...
  describe("form submission", () => {
    it("submits the closest form when type=submit", async () => {
      ...
      const button = /** @type {Button} */ (form.querySelector("md-button"));
      button.click();
