...
describe("md-switch", () => {
  ...
  describe("rendering", () => {
    it("renders an inner input[type=checkbox]", async () => {
      const el = /** @type {MdSwitch} */ (
        await fixture(html`<md-switch></md-switch>`)
      );
  ...
  describe("selected", () => {
    ...
    it("reflects selected attribute to the host", async () => {
      const el = /** @type {MdSwitch} */ (
        await fixture(html`<md-switch selected></md-switch>`)
      );
  ...
  describe("disabled", () => {
    ...
    it("reflects disabled attribute to the host", async () => {
      const el = /** @type {MdSwitch} */ (
        await fixture(html`<md-switch disabled></md-switch>`)
      );
  ...
  describe("icons", () => {
    ...
    it("renders .switch__icon when icons is true", async () => {
      const el = /** @type {MdSwitch} */ (
        await fixture(html`<md-switch icons></md-switch>`)
      );
    ...
    it("renders check icon when selected with icons", async () => {
      const el = /** @type {MdSwitch} */ (
        await fixture(html`<md-switch icons selected></md-switch>`)
      );
  ...
  describe("name and value", () => {
    ...
    it("passes name to the inner input", async () => {
      const el = /** @type {MdSwitch} */ (
        await fixture(html`<md-switch name="notifications"></md-switch>`)
      );
      expect(
        /** @type {HTMLInputElement} */ (el.shadowRoot.querySelector("input"))
          .name,
    ...
    it("passes value to the inner input", async () => {
      const el = /** @type {MdSwitch} */ (
        await fixture(html`<md-switch value="yes"></md-switch>`)
      );
      expect(
        /** @type {HTMLInputElement} */ (el.shadowRoot.querySelector("input"))
          .value,
  ...
  describe("required", () => {
    ...
    it("sets required on the inner input", async () => {
      const el = /** @type {MdSwitch} */ (
        await fixture(html`<md-switch required></md-switch>`)
      );
      expect(
        /** @type {HTMLInputElement} */ (el.shadowRoot.querySelector("input"))
          .required,
  ...
  describe("form association", () => {
    ...
    it("form getter returns the associated form", async () => {
      ...
      const el = /** @type {MdSwitch} */ (form.querySelector("md-switch"));
  ...
  describe("updated lifecycle", () => {
    ...
    it("reacts to value change by updating form value", async () => {
      const el = /** @type {MdSwitch} */ (
        await fixture(html`<md-switch selected value="yes"></md-switch>`)
      );
      el.value = "no";
      await el.updateComplete;
  ...
  describe("labels", () => {
    it("labels getter returns associated labels", async () => {
      ...
      const el = /** @type {MdSwitch} */ (container.querySelector("md-switch"));
