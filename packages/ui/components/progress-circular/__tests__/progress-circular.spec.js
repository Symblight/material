...
import "../progress-circular.js";
/** @import MdProgressCircular from "../progress-circular.js" */

describe("md-progress-circular", () => {
  describe("rendering", () => {
    it("renders an SVG with class progress-circular__svg", async () => {
      const el = /** @type {MdProgressCircular} */ (
        await fixture(html`<md-progress-circular></md-progress-circular>`)
      );
